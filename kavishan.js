...
var session = conf.session.replace(/KAVISHAN-MD;;;=>/g,"");
    ...
    async  function activateCrons() {
        ...
        zk.ev.on("connection.update", async (con) => {
            ...
            if (connection === "connecting") {
                console.log("ℹ️ kavishan is connecting...");
            }
            else if (connection === 'open') {
                console.log("✅ kavishan Connected to WhatsApp! ☺️");
                console.log("--");
