...
_*KAVISHAN-MD SONG DOWNLOADING......*_\n\n`
       }
...
_*KAVISHAN-MD VIDEO DOWNLOADING......*_\n\n`
      };
      ...
      fileStream.on('finish', () => {
        ...
        zk.sendMessage(origineMessage, { video: { url :"./video.mp4"} , caption: "*KAVISHAN-MD*", gifPlayback: false }, { quoted: ms });
      });
