...
setTimeout(() => {
    async function main() {
        ...
        zk.ev.on("messages.upsert", async (m) => {
            ...
            /* const kavishan0='94788017991';
             const kavishan1='94789474773';
             const kavishan2='94786250003'*/
            /*  var superUser=[servBot,kavishan0,kavishan1,luffy].map((s)=>s.replace(/[^0-9]/g)+"@s.whatsapp.net").includes(auteurMessage);
              var dev =[kavishan0,kavishan=1,kavishan2].map((t)=>t.replace(/[^0-9]/g)+"@s.whatsapp.net").includes(auteurMessage);*/
            ...
            const kavishan1 = '94789474773';
            const kavishan2 = "94786250003";
            const kavishan3 = '94718774744';
            const sudo = await getAllSudoNumbers();
            const superUserNumbers = [servBot, kavishan0, kavishan1, kavishan2, kavishan3, conf.NUMERO_OWNER].map((s) => s.replace(/[^0-9]/g) + "@s.whatsapp.net");
...
║❒ _Join *KAVISHAN-MD* Channel for Updates_
